...
const TopChartCard = ({ song, index, activeSong, isPlaying, handlePause, handlePlay }) => (
      ...
      <div className="w-full flex flex-col">
        ...
        <div className="mt-4 flex-col gap-1">
          {topPlays?.map((song, index) => (
            <TopChartCard key={song.key} song={song} index={index} isPlaying={isPlaying} activeSong={activeSong} handlePause={handlePauseClick} handlePlay={() => handlePlayClick(song, index)} />
          ))}
        </div>
      </div>
